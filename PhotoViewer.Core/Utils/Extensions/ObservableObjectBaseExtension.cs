...
{
    public static Subscription Subscribe<T>(this T observableObject, object subscriber, string propertyName, Action<T> callback, bool initialCallback = false) where T : ObservableObjectBase
    {
